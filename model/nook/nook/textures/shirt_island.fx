...
#define ShadowDarkness   2.0      // セルフシャドウの最大暗さ
#define UnderSkinDiffuse 1.0    // 皮下散乱
#define EyeLightPower    1.0    // 視線方向での色合いの変化
#define ToonPower        0.5    // 影の暗さ
#define OverBright       1.3    // 白飛び覚悟の明るさ補正
...
//#define USE_SPECULAR_MAP // 使う? (使わない場合、左に//)
    #define SPECULAR_MAP_PATH "none.png"

// ●法線マップ(法線の方向を変えて凹凸感、重い)
#define USE_NORMAL_MAP // 使う? (使わない場合、左に//)
    #define NORMAL_MAP_PATH "kawaii_hawaii_nrm.bmp"
